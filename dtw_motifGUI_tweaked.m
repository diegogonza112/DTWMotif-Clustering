...
[pr_rate,best_so_far,first_min,sec_min,DTW_time,top_k] = dtw_mpGUI_tweaked2(a', mpi_lbk, mp_sorted, subseqlen, minspacing, maxwarp,dnc,best_so_far,gui_name,first_min,sec_min,top_k_num);

% fprintf('Top %d DTW-identified motifs + MP''s:\n{',top_k_num);
% fprintf('{%d, %d, %d, %f},',[[1:size(top_k,1)]' top_k]');
x = [[1:size(top_k,1)]' top_k]';
tk = x;
