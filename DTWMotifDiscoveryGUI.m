function [best_so_far,motiffirst,motifsec, top_k] = DTWMotifDiscoveryGUI(TS,subseqlen,maxwarp)
    ...
    MPlatency = toc;
    sTime = tic;    
    [lb_t,sp_rates,pr_rate,prrate,best_so_far,motiffirst,motifsec,DTW_time, tk]= dtw_motifGUI_tweaked(TS,subseqlen, maxwarp,mp,gui_name);
    totalTime =toc(sTime)
