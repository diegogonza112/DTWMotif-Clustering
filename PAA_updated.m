...
% From Alaee (2021), p868: "Piecewise Aggregate Approximation (PAA):
% Definition 7: The PAA of time series T of length n can be calculated by dividing
% T into k equal-sized windows and computing the mean value of data within each
% window."
